...
```json
{
  ...
  "clawProfile": {
    ...
    "function": "string — 中文 2-6 字，如 军师、执行者、搭子、助理、分析师、研究员、教练、设计师、开发搭子、策展人、运营、翻译官、自动化专家、审核、辅导员、营销",
    "domain": "string — 中文 2-4 字工作领域，如 产品、编程、设计、AI、金融、内容、营销、数据、自动化、智能家居、音视频、项目管理、安全、客服、HR、翻译、教育、游戏、医疗、法律、电商、科学、运维",
